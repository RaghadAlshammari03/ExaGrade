...
urlpatterns = [
    ...
    path('<int:exam_id>/merge/', views.merge_papers_by_id, name='merge_papers'),
    path('<int:exam_id>/unmerge/', views.unmerge_papers_by_id, name='unmerge_papers'),
    path("merge/<int:exam_id>/", views.merge_papers, name="merge_papers"),
    path("unmerge/<int:paper_id>/", views.unmerge_paper, name="unmerge_paper"),
